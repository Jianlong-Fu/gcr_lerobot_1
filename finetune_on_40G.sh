python lerobot/scripts/dps_train.py \
    ...
    --job_name="pi0-04-25-ft-simpler-fractal-bs-16-2gpu-gra-acc-4-with-lr-decay-warm-1k-1st" \
    --log_dir="/mnt/wangxiaofa/logs" \
    --output_dir="/mnt/wangxiaofa/pi0-ft-simulated/0425-ft-simpler-fractal-bs-16-2gpu-gra-acc-4-with-lr-decay-warm-1k-1st" \
    --steps=120_000 \
