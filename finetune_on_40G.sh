python lerobot/scripts/dps_train.py \
    ...
    --dataset.data_mix="pizza_long_sub3_hz_15" \
    --dataset.image_transforms.enable=false \
    --wandb.enable=false \
    --resume=false \
    --wandb.project="pi0-ft-simulated" \
    --job_name="0915-pizza-long-sub3-hz-15-wo-state-resume" \
    --log_dir="/mnt/wangxiaofa/logs" \
    --output_dir="/mnt/wangxiaofa/pi0-ft-simulated/0915-pizza-long-sub3-hz-15-wo-state-resume" \
    --steps=300_000