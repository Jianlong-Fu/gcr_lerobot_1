python lerobot/scripts/dps_train.py \
    ...
    --job_name="06-30-pt-pi0-ft-pizza-bs-4-16gpu-gra-acc-2-with-lr-decay-warm-1k-wd-1e-2-1st" \
    --log_dir="/mnt/wangxiaofa/logs" \
    --output_dir="/mnt/wangxiaofa/pi0-ft-simulated/0630-ft-pizza-bs-4-16gpu-gra-acc-2-with-lr-decay-warm-1k-wd-1e-2-1st" \
    --steps=300_000 \
