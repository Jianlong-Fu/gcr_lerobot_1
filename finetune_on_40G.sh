python lerobot/scripts/dps_train.py \
    ...
    --job_name="pi0-04-24-ft-bridge-bs-8-2gpu-gra-acc-4-with-lr-decay-warm-2k-1st" \
    --log_dir="/mnt/wangxiaofa/logs" \
    --output_dir="/mnt/wangxiaofa/pi0-ft-simulated/0424-ft-bridge-bs-8-2gpu-gra-acc-4-with-lr-decay-warm-2k-1st" \
    --steps=240_000 \
