...
def make_policy(
    ...
    if weight_pt_path:
        ...
        unfit_weight_key = ["model.state_proj", "model.action_in_proj", 
                            "model.action_out_proj", "model.action_time_mlp_in", 
                            "model.action_time_mlp_out"]
        filtered_weights = {k: v for k, v in weights.items() if "gemma_expert" not in k and not any(key in k for key in unfit_weight_key)}
