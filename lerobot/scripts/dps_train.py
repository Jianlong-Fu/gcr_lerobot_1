...
def train(cfg: TrainPipelineConfig):
    ...
    policy = make_policy(
        ...
        # weight_pt_path="/mnt/wangxiaofa/pi0-ft-simulated/0412-ft-libero-goal-bs-32-8gpu-gra-acc-1-with-lr-decay-warm-2k-1st/global_step7500/mp_rank_00_model_states.pt"
    )
